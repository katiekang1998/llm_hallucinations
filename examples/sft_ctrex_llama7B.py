...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/sft_ctrex_llama7B_2_commit_idk_lr1e-5_2"
    # config.train.epochs = 100
    config.train.project_name = "trlx_sft_ctrex_llama7B_2"
    config.train.run_name = "commit_idk_lr1e-5_2"
