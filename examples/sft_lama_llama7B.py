...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/sft_lama_llama7B_commit_idk_hedge_lr1e-5"
    # config.train.epochs = 100
    config.train.project_name = "trlx_sft_lama_llama7B"
    config.train.run_name = "commit_idk_hedge_lr1e-5"
