...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/rm_wikiplots_llama7B"
    config.train.batch_size = 32//3

    # config.train.epochs = 100
    config.train.project_name = "rm_wikiplots"

    config.train.run_name = "llama7B"
    ...
    train_titles =  train_data["titles"]
    test_titles = np.load("ckpts/wikiplots_data/test_titles.npy")




    with open("ckpts/wikiplots_data/rm_data/llama7b/factscores_train.json", "r") as f:
    ...
    with open("ckpts/wikiplots_data/rm_data/llama7b/factscores_test.json", "r") as f:
        factscores = json.load(f)
