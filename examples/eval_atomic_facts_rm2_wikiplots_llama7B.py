...
def main(hparams={}):
    # model_path = "ckpts/rm2_atmoic_facts_wikiplots_llama7B/checkpoint_10000/hf_model/"
    model_path = "ckpts/rm2_atmoic_facts_wikiplots_gpt3pt5_llama7B/checkpoint_10000/hf_model/"
