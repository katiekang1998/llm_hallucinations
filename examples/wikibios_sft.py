...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/sft_wikibios"
    config.train.project_name = "sft_wikibios"
    config.train.run_name = "orig"
    config.train.num_log_samples = -1
    config.train.batch_size = 24//3
    ...
    prompts_test = list(map(prepare_prompt, test_names))
