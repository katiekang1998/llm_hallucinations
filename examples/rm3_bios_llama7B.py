...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/rm3_bios_llama7B"
    # config.train.epochs = 100
    config.train.project_name = "trlx_rm2_bio2_llama7B"
    config.train.run_name = "train10000_rm3"
    ...
    train_samples = list(map(prepare_sample, lines_all, num_total_all, num_true_all))
