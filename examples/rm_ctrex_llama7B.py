...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/rm_ctrex_llama7B_2gpu"
    # config.train.epochs = 100
    config.train.project_name = "trlx_rm_ctrex_llama7B"
    config.train.run_name = "2_gpu"
    ...
    train_incorrect_tails = np.load("custom_trex/train_incorrect_tails.npy")
    test_incorrect_tails = np.load("custom_trex/test_small_incorrect_tails.npy")
