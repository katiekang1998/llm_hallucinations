...
def main(hparams={}):
    ...
    config.train.project_name = "wikibios_rm_llama7B"
    ...
    with open("ckpts/wikibios_data/rm_data/llama7b/factscores_train5000.json", "r") as f:
        factscores = json.load(f)

    with open("ckpts/wikibios_data/rm_data/llama7b/factscores_train5000_10000.json", "r") as f:
    ...
    with open("ckpts/wikibios_data/rm_data/llama7b/factscores_test.json", "r") as f:
        factscores = json.load(f)
