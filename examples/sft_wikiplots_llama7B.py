...
def main(hparams={}):
    ...
    config.train.checkpoint_dir = "ckpts/sft_wikiplots_common_llama7B"
    # config.train.epochs = 100
    config.train.project_name = "trlx_sft_wikiplots_llama7B"
    config.train.run_name = "common"
    ...
    train_samples = list(map(prepare_sample, titles[train_idxs], plots[train_idxs]))
